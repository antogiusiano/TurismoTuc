        ...
        <form onSubmit={handleSubmit}>
          <div className="row mb-3">
            <div className="col-md-6">
              ...
              <input type="text" name="nombre" className="form-control"
                value={turista.nombre} onChange={handleChange} required />
            </div>
            <div className="col-md-6">
              <label className="form-label">Apellido</label>
              <input type="text" name="apellido" className="form-control"
                value={turista.apellido} onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="row mb-3">
            <div className="col-md-6">
              ...
              <input type="email" name="email" className="form-control"
                value={turista.email || ""} onChange={handleChange} />
            </div>
            <div className="col-md-6">
              <label className="form-label">Teléfono</label>
              <input type="text" name="telefono" className="form-control"
                value={turista.telefono || ""} onChange={handleChange} />
            </div>
          </div>
          ...
          <div className="mb-3">
            ...
            <input type="text" name="direccion" className="form-control"
              value={turista.direccion || ""} onChange={handleChange} />
          </div>

          <div className="mb-3">
            <label className="form-label">Nacionalidad</label>
            <input type="text" name="nacionalidad" className="form-control"
              value={turista.nacionalidad || ""} onChange={handleChange} />
          </div>
